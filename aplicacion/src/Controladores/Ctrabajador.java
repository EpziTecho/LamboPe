...
public class Ctrabajador {
    ...
    public void rellenaTablaTrabajadores() {
        ...
        for (Trabajador t : lista) {
            ...
            datos[5] = t.getEmail();
            datos[6] = t.getacceso();
            datos[7] = t.getUsuario();
            datos[8] = t.getContrasena();
            datos[9] = t.getEstado();
    ...
    public void editarTrabajador() {
        ...
        if (seleccion >= 0) {
            ...
            String acceso = (String) vistaTrabajadores.getTMJTableTrabajadores().getValueAt(seleccion, 6);
            String usuario = (String) vistaTrabajadores.getTMJTableTrabajadores().getValueAt(seleccion, 7);
            String contrasena = (String) vistaTrabajadores.getTMJTableTrabajadores().getValueAt(seleccion, 8);
            String estado = (String) vistaTrabajadores.getTMJTableTrabajadores().getValueAt(seleccion, 9);

            vistaTrabajadores.AbreEditarTrabajador(dni, nombre, apellidos, direccion, telefono, email, acceso, usuario, contrasena, estado);
