...
import Controladores.CJDAlquiler;
...
/**
 * JDialog de Alquiler del Programa.
 * Está clase contiene los constructores y métodos de creación de la Vista
 * de JDialog de Extra. Este dialog será una ventana que se abre desde el JFrame de Alquiler.
 * La función de esta ventana es la de introducir o editar Alquilers.
 * @author  grupo2
 */
public class JDAlquiler extends javax.swing.JDialog {

    private CJDAlquiler controladorAlquiler;
    ...
    public JDAlquiler(java.awt.Frame parent, boolean modal) {
        ...
        ocultaCampoId();
        desactivarCampos();
        controladorAlquiler = new CJDAlquiler(this);
    }

    /**
     * Constructor creado para poder pasar los parametros de Frame inicio del DNI
     * del trabajador que ha iniciado sesion para cuando creamos una nueva Alquiler
     *
     * @param dniTrabajador
     ...
     * @param modal
     */
    public JDAlquiler(String dniTrabajador, String nombreTrabajador, String apellidosTrabajador, boolean funcion, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ocultaCampoId();
        setFuncion(funcion);
        ...
        // Rellena el jdte chooser de fecha de Alquiler con la fecha actual del sistema
        jDateChooserFechaAlquiler.setDate(controladorAlquiler.fechaActual());

    }

    /**
     * Creamos un constructor para el JDialog que se le puedan pasar los
     * parametros desde el JFrame Alquiler. Este sirve para editar los datos.
     * Rellena los campos con los datos de la Alquiler seleccionada.
     *
     * @param idalquiler
     * @param matricula
     * @param modelo
     ...
     * @param modal
     */
    public JDAlquiler(int idalquiler, String matricula, String modelo, String dniCliente, String nyapCliente, String dniTrabajador, String nyapTrabajador, int idExtra, String nombreExtra, String tipoTarifa, Date fechaAlquiler, Date fechaRecogida, Date fechaDevolucion, double costoAlquiler, String estado, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ocultaCampoId();
        controladorAlquiler = new CJDAlquiler(this);

        jTextFieldId.setText(String.valueOf(idalquiler));
        ...
        jDateChooserFechaAlquiler.setDate(fechaAlquiler);
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Datos Alquileres");

        jPanel1.setBackground(new java.awt.Color(57, 92, 120));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)), "Datos de Reservas", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jLabelVehiculo.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabelTrabajador.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabelFechaSalida.setForeground(new java.awt.Color(255, 255, 255));
        jLabelFechaSalida.setText("Fecha de Devolucion:");

        jLabelCoste.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabelExtra.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabelTipoTarifa.setForeground(new java.awt.Color(255, 255, 255));
        jLabelTipoTarifa.setText("Tipo de Tarifa:");

        jRadioButtonTarifaBasica.setBackground(new java.awt.Color(57, 92, 120));
        buttonGroup1.add(jRadioButtonTarifaBasica);
        jRadioButtonTarifaBasica.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButtonTarifaBasica.setText("Tarifa Básica");

        jRadioButtonTarifaAmpliada.setBackground(new java.awt.Color(57, 92, 120));
        buttonGroup1.add(jRadioButtonTarifaAmpliada);
        jRadioButtonTarifaAmpliada.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jButtonTBasica.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jButtonTAmpliada.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabelFechaReserva.setForeground(new java.awt.Color(255, 255, 255));
        jLabelFechaReserva.setText("Fecha de Alquiler:");
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (controladorAlquiler.guardar() == true) {
    ...
    private void jButtonVehiculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVehiculoActionPerformed
        ...
        JDListaVehiculos vv = new JDListaVehiculos(JDAlquiler.this, true);
        ...
        vv.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent evt) {
                ...
                controladorAlquiler.rellenaCamposVehiculo();
            }
        });
    ...
    private void jButtonClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonClienteActionPerformed
        ...
        JDListaClientes vc = new JDListaClientes(JDAlquiler.this, true);
        ...
        vc.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent evt) {
                // El metodo rellenatabla actualizará la tabla
                controladorAlquiler.rellenaCamposCliente();
            }
        });
    ...
    private void jButtonExtraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExtraActionPerformed
        ...
        JDListaExtras ve = new JDListaExtras(JDAlquiler.this, true);
        ...
        ve.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent evt) {
                // El metodo rellenatabla actualizará la tabla
                controladorAlquiler.rellenaCamposExtras();
            }
        });
    ...
    private void jButtonCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCalcularActionPerformed
        ...
        if ( controladorAlquiler.calculaPrecio() == false) {
    ...
    private void jButtonTBasicaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTBasicaActionPerformed
       ...
       JDTarifaBasica tb = new JDTarifaBasica(JDAlquiler.this, true);
    ...
    private void jButtonTAmpliadaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTAmpliadaActionPerformed
       ...
       JDTarifaAmpliada ta = new JDTarifaAmpliada(JDAlquiler.this, true);
   ...
   public String getPrecio(){
    ...
    public void desactivarCampos() {
        ...
        jDateChooserFechaAlquiler.setEnabled(false);
    }
