...
public class JFrameTrabajador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 255, 255)), "Listado de Trabajadores", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jMenuISalir.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, java.awt.event.InputEvent.CTRL_DOWN_MASK));
...
/**
     ...
     *
     */
    public void AbreEditarTrabajador(String dni, String nombre, String apellidos, String direccion, int telefono, String email, String acceso, String usuario, String contrasena, String estado) {
        // Creamos un nuevo JDialog de tipo trabajador
        JDialog dialog = new JDTrabajador(dni, nombre, apellidos, direccion, telefono, email, acceso, usuario, contrasena, estado, JFrameTrabajador.this, true);
        // Creamos un WindowListener, que no hará más que escuchar para un posible evento de ventana
        dialog.addWindowListener(new WindowAdapter() {
            @Override
            //llamamos al metodo windowClosed que hará algo cuando la ventana que escuchamos se cierre, en este caso el JDialog
